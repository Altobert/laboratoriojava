...
public class Aliado {
	...
	public Aliado(Integer id, Integer posicion, Integer distMaximaMov, Integer vida, String nombreEquipo) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Aliado [id=" + id + ", posicion=" + posicion + ", distMaximaMov=" + distMaximaMov + ", vida=" + vida
